                ...
                <div class="px-6 py-4">
                    <ul class="w-full flex text-center">
                        <li class="w-full flex justify-center">
                            <a href="facebook.com" target="_blank" class="text-gray-600 hover:text-blue-500">
                        ...
                        <li class="w-full flex justify-center">
                            <a href="twitter.com" target="_blank" class="text-gray-600 hover:text-blue-500">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
                        ...
                        <li class="w-full flex justify-center">
                            <a href="instagram.com" target="_blank" class="text-gray-600 hover:text-blue-500">
